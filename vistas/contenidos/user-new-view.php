            ...
            <div class="row">
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="usuario_dni_reg" id="usuario_dni" maxlength="20">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="usuario_clave_1_reg" id="usuario_clave_1" maxlength="100">
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="usuario_clave_2" class="bmd-label-floating">Repetir contraseña</label>
                        <input type="password" class="form-control" name="usuario_clave_2_reg" id="usuario_clave_2"  maxlength="100">
                    </div>
                </div>
            </div>
        </div>
